...
const ContactSection = () => {
  const links = [
    { icon: Phone, label: "Phone", value: "+353 894 355 738", href: "tel:+353894355738" },
    { icon: Mail, label: "Email", value: CONTACT_EMAIL, href: `mailto:${CONTACT_EMAIL}` },
    { icon: Linkedin, label: "LinkedIn", value: "linkedin.com/in/bhavana-mamidi-47202a172", href: "https://www.linkedin.com/in/bhavana-mamidi-47202a172" },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">Open to operations and analyst roles across Ireland.</p>
          </div>
