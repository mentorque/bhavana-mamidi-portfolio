    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10 pt-20 pb-16">
        ...
        <p className="text-base md:text-lg text-white/80 mb-10 max-w-2xl mx-auto leading-relaxed animate-slide-up px-2">
          Results-driven operations professional with 4+ years of multinational experience specializing in
          process optimization, KPI reporting, and cross-functional leadership across Ireland and India.
        </p>
