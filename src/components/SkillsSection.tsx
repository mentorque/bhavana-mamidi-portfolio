  ...
  const skillCategories = [
    {
      ...
      skills: ["SOP Design", "Quality Assurance", "Escalation Management", "SLA Compliance", "Workforce Coordination", "Inventory Control"],
    },
    {
      title: "Customer & Payment Ops",
      skills: ["Omnichannel Support", "Payment Processing", "Trust & Safety", "Process Improvement"],
    },
    {
      title: "Analytics & Reporting",
      skills: ["Tableau", "SQL (Basic)", "MS Excel", "Pivot Tables", "KPI Dashboards", "Data Reporting"],
    },
    {
      title: "CRM & Business Tools",
      skills: ["Salesforce", "Zendesk", "Dealer Management Systems (DMS)", "MS Office Suite", "MS Teams", "Slack"],
    },
    {
      title: "Leadership & Communication",
      skills: ["Team Leadership", "Coaching & Mentoring", "Stakeholder Communication", "Critical Thinking"],
    },
    {
      title: "Languages",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">Operations, analytics, CRM, and leadership capabilities built across multinational roles.</p>
          </div>
